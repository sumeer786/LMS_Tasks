...
public class FootballPlayer40YardDashInfo {
    ...
    public void printPlayersWith40Avg(){
        ...
        for(FootballPlayer player : players){
            ...
            double[] fortyYardDashTimes = player.getFortyYardDashTimes();

            for(int i = 0; i < player.getFortyYardDashTimes().length; i++){

                total40YdDashTimes += fortyYardDashTimes[i];

            }

            double avg40YdTime = total40YdDashTimes / player.getFortyYardDashTimes().length;
